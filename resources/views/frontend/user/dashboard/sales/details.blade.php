										...
										<div class="card card-flush py-4 flex-row-fluid">
											...
											<div class="card-header">
												<div class="card-title">
													<h2>Order No #{{$orderData->invoice}}</h2>
												</div>
											</div>
											<!--end::Card header-->
											<!--begin::Card body-->
												...
												<form action="{{ route('order.update',$orderData->id) }}" method="POST" enctype="multipart/form-data" id="choice_form" class="form d-flex flex-column flex-lg-row" >
													...
													<div class="w-100 flex-lg-row-auto w-lg-300px mb-7 me-2 me-lg-1">
														...
														<div class="card-body pt-0">
															...
															<div class="form-group"><label for="" class="col-12 col-form-label">Status </label><div class="col-12"><input type="text" value="{{$orderData->delivery_status}}" name="invoice" class="form-control"></div></div>
