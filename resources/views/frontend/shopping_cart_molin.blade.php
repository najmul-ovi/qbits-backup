            ...
            <div class="shoppingcart-content">
                ...
                @foreach (App\Models\Cart::totalCarts() as $cart)
                  ...
                  <div class="row">
                                ...
                                <div class="shopping-cart-des" style="width: 57% !important;text-align:justify;">
                                    ...
                                    <td class="cart-product-quantity" width="130px">
                                        ...
                                        <div class="input-group quantity" style="width: 30% !important;margin-left:18px;">
                                            ...
                                            <input type="text" class="qty-input form-control" maxlength="2" max="10" value="{{$cart->quantity}}">
                                      ...
                                      <div class="col-xs-12">
                                          <div class="order-summery-list">
                                            <input type="hidden" class="product_id" value="" >
                                              <ul>
                                                  <li>Unit Price:  <span class="list-value unit_price"> ৳{{ $cart->product->unit_price}}</span></li>
                                                  ...
                                                  <li>Subtotal:   <span class="list-value subtotal">৳{{$cart->product->unit_price * $cart->quantity}}</span></li>
                                                  <li>Shipping Cost:  <span class="list-value">৳50</span></li>
                                                  <li style="font-weight: 600;">Gross Total: <span class="list-value gross_total">৳{{$cart->product->unit_price * $cart->quantity + 50}}</span></li>
                                              </ul>
                                          </div>
                                      </div>
                                 </div>
                      ...
                      <a href="#" class="btn process-check-btn" style="text-align:center;">Process to Checkout</a><br/>
