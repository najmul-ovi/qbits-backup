                                ...
                                <div class="shopping-cart-des" style="width: 57% !important;text-align:justify;">
                                    ...
                                    <td class="cart-product-quantity" width="130px">
                                        ...
                                        <div class="input-group quantity" style="width: 30% !important;margin-left:18px;">
                                            ...
                                            <input type="text" class="qty-input form-control" maxlength="2" max="10" value="{{$carts->quantity}}">
                                          ...
                                          <div class="order-summery-list">
                                            <input type="hidden" class="product_id" value="{{ $products->id }}" >
                                              <ul>
                                                  ...
                                                  <li>Quantity:  <span class="list-value qty-input"> X {{$array->quantity}} PC/S</span></li>
                                                  <input type="hidden" class="hidden-qty-input" name="hidden-qty-input" value="135" >
                                                  <li>Subtotal:   <span class="list-value subtotal">৳{{$products->unit_price * $array->quantity}}</span></li>
                                                  <li>Shipping Cost:  <span class="list-value">৳50</span></li>
                                                  <li style="font-weight: 600;">Gross Total: <span class="list-value gross_total">৳{{$products->unit_price * $array->quantity + 50}}</span></li>
                                              </ul>
                                          </div>
                                      </div>
                                 </div>
