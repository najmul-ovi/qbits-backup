...
{{-- <meta property="og:locale" content="en_US" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="print-content-only header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		<!--begin::Main-->
		<!--begin::Root-->
									...
									<div class="mw-lg-950px mx-auto w-100">
										...
										<div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
											...
											<div class="text-sm-end">
												<!--begin::Logo-->
												<a href="#">
													<img src="{{ asset('frontend/assets/logo/qbits_logo.png')}}" alt="qbits Logo" class="img-responsive">
												</a>
												<!--end::Logo-->
												<!--begin::Text-->
												<div class="text-sm-end fw-bold fs-4 text-muted mt-7">
                                                    ...
                                                    <span style="font-weight: bold;"> 793/1 Middle, S Monipur Rd</span><br>
                                                        
                                                        <span>Phone: +1-415-800-4984</span><br>
												</div>
												<!--end::Text-->
											</div>
										</div>
											...
											<div class="d-flex justify-content-between flex-column flex-md-row">
												...
												<div class="flex-grow-1 pt-8 mb-13">
														...
														<table class="table">
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <tr>
                                                                ...
                                                                @if( $orders_new->payment_type == 'COD')
													...
													<div class="d-flex flex-column mw-md-300px w-100">
														<!--begin::Label-->
														<div class="fw-bold fs-5 mb-3 text-dark00">Invoice To</div>
														<!--end::Label-->
														<!--begin::Item-->
														...
														<div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
															...
															<!--end::Accountnumber-->
															<!--begin::Number-->
															<div class="text-end fw-norma">{{ auth()->user()->email}}</div>
															<!--end::Number-->
														</div>
														<!--end::Item-->
														<!--begin::Item-->
														<div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															<div class="fw-bold pe-5">Address:</div>
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">{{ auth()->user()->address}}</div>
															<!--end::Label-->
														</div>
                                                        <div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															...
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">{{ auth()->user()->phone}}</div>
															<!--end::Label-->
														</div>
                                                        <div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															<div class="fw-bold pe-5">Selected Shipping Method:</div>
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">{{ $orders_new->shipping_method }}</div>
															<!--end::Label-->
														</div>
                                                        <div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															<div class="fw-bold pe-5">Shipping Address:</div>
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">{{ $orders_new->shipping_address }}</div>
															<!--end::Label-->
														</div>

                                                        <div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															<div class="fw-bold pe-5">Method Status:</div>
															<!--end::Code-->
															<!--begin::Label-->
                                                            @if( $orders_new->payment_type == 'COD')
                                                            <div class="text-end fw-norma">Cash On Delivery</div>
                                                            @endif
												...
												<div class="text-end pt-10">
													...
													<div class="fs-xl-2x fs-2 fw-boldest">৳{{$amount}}</div>
													<!--end::Total Amount-->
													<!--begin::Invoice To-->
													<!--end::Invoice To-->
													<!--begin::Invoice No-->
													<div class="text-gray-600 fs-6 fw-bold mb-3">INVOICE NO.</div>
													<div class="fs-6 text-gray-800 fw-bold mb-8"> <strong>2020</strong>{{ $order->id }}</div>
													<!--end::Invoice No-->
													<!--begin::Invoice Date-->
													<div class="text-gray-600 fs-6 fw-bold mb-3">DATE</div>
													<div class="fs-6 text-gray-800 fw-bold">{{ $order->created_at }}</div>
													<!--end::Invoice Date-->
												</div>
												<!--end::Content-->
											</div>
										...
										<div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
											...
											<div class="my-1 me-5">
												...
												<!-- end::Pint-->
												<!-- begin::Download-->
												<a class="btn btn-light-success my-1" href="{{ route('index')}}">Home</a>
												<!-- end::Download-->
											</div>
											<!-- end::Actions-->
											<!-- begin::Action-->
