            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Vendor" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Vendor</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $vendor->name}}</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $vendor->email}}</a>
                            </td>
                            <!--end::Email=-->
                            <!--begin::Company=-->
                            <td>{{ $vendor->phone}}</td>
                            ...
                            <td data-filter="mastercard">{{ $vendor->address}}</td>
                            <!--end::Payment method=-->
                            <!--begin::Date=-->
                            <!--end::Date=-->
                            <!--begin::Action=-->
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <span class="menu-link px-3" data-kt-customer-table-filter="edit_miller_row" data-ecc-route="{{route('vendor.edit',['vendor'=>$vendor->id])}}" data-modal-header="Update a Vendor" data-id="{{$vendor->id}}">Edit</span>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <span class="menu-link px-3" data-kt-customer-table-filter="delete_row" data-ecc-route="{{route('vendor.destroy',['vendor'=>$vendor->id])}}" data-id="{{$vendor->id}}">Delete</span>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
        ...
        <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ route('vendor.store')}}" id="kt_modal_add_customer_form" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold mb-2">Vendor Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Please Enter Name" name="name" value="" />
                                    <!--end::Input-->
                                </div>
                                        ...
                                        <div data-repeater-item>
                                            <div class="form-group row mb-5">
                                                <div class="col-md-3" id="bank_name">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-solid" placeholder="Bank Name" name="name" value="" style="padding: 15px"/>

                                                    {{-- <textarea id="bank_name" class="form-control" name="name" cols="8" rows="2" style="resize: none;"></textarea> --}}
                                                    ...
                                                    <!--end::Input-->
                                                     ...
                                                     <!--end::Label-->
                                                     <!--begin::Input-->
                                                     <input class="form-control form-control-solid" placeholder="Account Name" name="acc_name" value="" style="padding: 15px"/>
                                                     
                                                     {{-- <textarea id="account_name" class="form-control" name="acc_name" cols="8" rows="2" style="resize: none;"></textarea> --}}
                                                     <!--end::Input-->
                                                </div>
                                                <div class="col-md-3" id="branch_name">
                                                    ...
                                                    {{-- <input type="number" class="form-control" name="acc_no" placeholder="Enter Account Number" /> --}}
                                                </div>
                                                <div class="col-md-2">
