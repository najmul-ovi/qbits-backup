            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Agent" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-modal-header="Add an Agent" data-bs-target="#kt_modal_add_customer">Add Agent</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $agent->name}}</a>
                            </td>
                            <td>
                            <?php
                            ...
                            $millerName = '';
                            foreach($agent->millerName as $miller) {
                                $millerName .= ", $miller->contact_name";
                            }
                            echo substr($millerName, 1); // remove leading ","
                            ?>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            ...
                            {{-- <td data-filter="mastercard">{{ $agent->bank}}</td> --}}
                            <td data-filter="mastercard">{{ $agent->address}}</td>
                            <!--end::Payment method=-->
                            <!--begin::Date=-->
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <span class="menu-link px-3" data-kt-customer-table-filter="edit_miller_row" data-ecc-route="{{route('agent.edit',['agent'=>$agent->id])}}" data-modal-header="Update an Agent" data-id="{{$agent->id}}">Edit</span>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <span class="menu-link px-3" data-kt-customer-table-filter="delete_row" data-ecc-route="{{route('agent.destroy',['agent'=>$agent->id])}}" data-id="{{$agent->id}}">Delete</span>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--end::Menu item-->
                                </div>
        ...
        <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ route('agent.store')}}" id="kt_modal_add_customer_form" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_customer_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Add a Agent</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold mb-2">Agent Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7" id="miller_name">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold mb-2">Miller Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-control-solid"  data-control="select2" data-placeholder="Select an option" name="miller_id[]" data-dropdown-parent="#miller_name" multiple="multiple">
                                        ...
                                        @foreach($millers as $miller)
                                            <option value="{{ $miller->id}}">{{ $miller->contact_name}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="form-group">
                                    <div data-repeater-list="kt_docs_repeater_advanced">
                                        <div data-repeater-item>
                                            <div class="form-group bank-repeater row mb-5" id="data-repeater-item-bank">
