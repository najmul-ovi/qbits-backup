            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Miller" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Miller Name</th>
                            <th class="min-w-125px">Miller Business Name</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo7/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $miller->contact_name}}</a>
                            </td>
                            <td>
                                <a href="../../demo7/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $miller->business_name}}</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $miller->email}}</a>
                            </td>
                            <!--end::Email=-->
                            <!--begin::Company=-->
                            <td>{{ $miller->phone}}</td>
                            ...
                            <td data-filter="mastercard">{{ $miller->address}}</td>
                            <!--end::Payment method=-->
                            <!--begin::Date=-->
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <span class="menu-link px-3" data-kt-customer-table-filter="edit_miller_row" data-ecc-route="{{route('miller.edit',['miller'=>$miller->id])}}" data-modal-header="Update a Miller" data-id="{{$miller->id}}">Edit</span>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row" data-ecc-route="{{route('miller.destroy',['miller'=>$miller->id])}}" data-id="{{$miller->id}}">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold mb-2">Miller Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Please Enter Miller Name" name="contact_name" value=""/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Please Enter Business Name" name="business_name" value=""/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" class="form-control form-control-solid" placeholder="Please Enter Miller Email" name="email" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-2">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Please Enter Miller Phone Number" name="phone" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                {{-- <div id="kt_modal_add_customer_billing_info" class="collapse show"> --}}
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="Please Enter Address Here" name="address" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                {{-- </div> --}}
                                ...
                                {{-- <div id="kt_modal_add_customer_billing_info" class="collapse show"> --}}
                                    <!--begin::Input group-->
                                    <div class="input-group d-flex flex-column mb-7 fv-row" id="district_name">
                                        <!--begin::Label-->
                                        ...
                                        <div data-repeater-item>
                                            <div class="form-group row mb-5">
                                                <div class="col-md-3" id="bank_name">
                                                    ...
                                                    <textarea id="bank_name" class="form-control" name="bank_name" cols="8" rows="2" style="resize: none;"></textarea>

                                                    <!--end::Input-->
                                                     <!--begin::Label-->
                                                     <label class="required fs-6 fw-bold mb-2">Account Name</label>
                                                     <!--end::Label-->
                                                     <!--begin::Input-->
                                                     <textarea id="account_name" class="form-control" name="account_name" cols="8" rows="2" style="resize: none;"></textarea>
                                                     <!--end::Input-->
                                                </div>
                                                <div class="col-md-3" id="branch_name">
                                                     <!--begin::Label-->
                                                    <label class="required fs-6 fw-bold mb-2">Branch Name</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <textarea id="branch_name" class="form-control" name="branch_name" cols="8" rows="2" style="resize: none;"></textarea>
                                                    <!--end::Input-->
                                                    <label class="form-label">Account number:</label>
                                                    <input type="number" class="form-control" name="acc_no" placeholder="Enter contact rate" />
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-1" style="margin-left: -30px;">
                                                    <!--begin::Form group-->
                                                    <a href="javascript:;" data-repeater-create class="btn btn-sm btn-light-primary mt-3 mt-md-9">
