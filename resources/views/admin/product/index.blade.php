                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center min-w-100px">Added By</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="text-center pe-0" data-order="2">
                                    @if($product->current_stock < 100) <span class="badge badge-light-warning">Low
                                        stock</span>
                                        <span class="fw-bolder text-warning ">{{ $product->current_stock}}</span>

                                        @else

                                        <span class="badge badge-light-success">heigh stock</span>
                                        <span class="fw-bolder text-success ">{{ $product->current_stock}}</span>
                                ...
                                <td class="text-center pe-0" data-order="active">
                                ...
                                <!--end::Status=-->
                                <td class="text-center pe-0">
                                    <span class="fw-bolder text-dark">{{ $product->unit_price}}</span>
                                </td>
