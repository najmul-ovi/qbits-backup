                     ...
                     <tbody class="fw-bold text-gray-600">
                         ...
                         <tr>
                             ...
                             <td>
                                 ...
                                 <a href="../../demo7/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $order->user->name}}</a>
                             </td>
                             <td>
                                ...
                                echo substr($productName, 1); // remove leading ","
                                ?>
                             ...
                             <!--begin::Email=-->
                             <td>
                                 <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $order->bank->name}}</a>
                             </td>
                             <!--end::Email=-->
                             <!--begin::Company=-->
                             ...
                             <td class="text-end">
                                 ...
                                 <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                     ...
                                     <!--begin::Menu item-->
                                     <div class="menu-item px-3">
                                        <a href="{{route('purchaseorder.edit',$order->id)}}"> <span class="menu-link px-3" data-kt-customer-table-filter="edit_miller_row" data-ecc-route="{{route('purchaseorder.edit',$order->id)}}" data-modal-header="Update a Purchase Order" data-id="$order->id">Edit</span></a>
                                     </div>
                                     <!--end::Menu item-->
                                     <!--begin::Menu item-->
                                     <div class="menu-item px-3">
