            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('purchaseorder.update',$order->id)}}" method="POST" id="kt_invoice_form">
                            @csrf
                            @method('PUT')
                            <!--begin::Wrapper-->
                            ...
                            <div class="mb-0">
                                        ...
                                        <div class="mb-5">
                                                        <!--begin::Input group-->
                                                            <div class="input-group d-flex flex-column mb-7 fv-row" id="vendor_name">
                                                                ...
                                                                <!--begin::Input-->
                                                                <select name="vendor_id" id="vendor_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="false" data-dropdown-parent="#vendor_name" disabled>
                                                                    <option></option>
                                                                    @foreach (\App\Models\User::all() as $vendor)
                                                                    <option value="{{ $vendor->id }}" @if($order->agent_id == $vendor->id) selected @endif>{{ $vendor->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <!--end::Input-->
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="notes" class="form-control form-control-solid" rows="3" placeholder="Thanks for your business" disabled>{{$order->comments}}</textarea>
                                </div>
                                <!--end::Notes-->
                    ...
                    <div class="card-body p-10">
                        ...
                        <div class="mb-10">
                            ...
                            <select id="vendor_pay_method" name="pay_method" data-control="select2" data-placeholder="Select Payment Method" class="form-select form-select-solid" data-hide-search="true">
                                ...
                                <option value="{{ $vendor_payment->id }}" @if($order->bank_id == $vendor_payment->id) selected @endif>{{ $vendor_payment->name }}</option>
                                @endforeach
                                {{-- <option></option>
                        ...
                        <div class="mb-8">
                            ...
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <select name="payment_status_id" id="my_bank_payment_status_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                    ...
                                    <option value="{{ $payment_status->id }}" @if($order->payment_status_id == $payment_status->id) selected @endif>{{ $payment_status->name }}</option>
                                    @endforeach
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <input disabled name="date" class="form-control form-control-solid" placeholder="Payment Date" id="kt_daterangepicker_3" value="{{ $order->date}}"/>
                            </label>
                            <!--end::Option-->
                            <!--begin::Option-->
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                            ...
                            <!--end::Option-->
                             ...
                             <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <input disabled type="text" class="form-control form-control-solid" name="check_no" placeholder="cheque Number" id="my_own_bank_chk_id" value="{{ $order->check_no }}"/>
                            </label>
                            <!--end::Option-->
                            ...
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <select name="order_status_id" disabled id="purchase_order_status_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                    ...
                                    <option value="{{ $order_status->id }}" @if($order->order_status_id == $order_status->id) selected @endif>{{ $order_status->name }}</option>
                                    @endforeach
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <input disabled name="receive_date" class="form-control form-control-solid" placeholder="Payment Date" id="kt_daterangepicker_new" value="{{ $order->receive_date}}"/>
