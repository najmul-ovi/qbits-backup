                        ...
                        <form action="{{ route('purchaseorder.store')}}" method="POST" id="kt_invoice_form">
                            ...
                            <div class="d-flex flex-column align-items-start flex-xxl-row">
                                ...
                                <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                    ...
                                    <input type="text" class="form-control form-control-flush fw-bolder text-muted fs-3 w-125px" value="" placehoder="..." />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                    ...
                                    <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" data-kt-element="items">
                                        ...
                                        <tbody>
                                            <tr class="border-bottom border-bottom-dashed" data-kt-element="item" id="raw_material">
                                                <td class="pe-7">
                                                    <select name="name[]" id="material_id" class="form-select form-select-solid mb-2" data-control="select2" data-placeholder="Select an option" data-hide-search="false" data-dropdown-parent="#raw_material">
                                                        <option></option>
