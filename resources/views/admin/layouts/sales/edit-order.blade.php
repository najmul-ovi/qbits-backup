					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								<!--begin::Form-->
								<form action="{{ route('order.update',$orderData->id) }}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" >
													...
													<div class="d-flex flex-column gap-5 gap-md-7" id="kt_ecommerce_edit_order_shipping_form">
														...
														<div class="d-flex flex-column flex-md-row gap-5">
															<div class="fv-row flex-row-fluid">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control" name="shipping_address" placeholder="Address Line 1" value="{{@$orderData->shipping_address}}" />
																<!--end::Input-->
															</div>
															<!-- <div class="flex-row-fluid">
