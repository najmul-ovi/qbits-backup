								...
								<div class="d-flex flex-column flex-xl-row">
											...
											<div class="card-body pt-15">
												...
												<div class="d-flex flex-center flex-column mb-5">
													...
													<div class="symbol symbol-100px symbol-circle mb-7">
														<img src="{{(!empty($customer->avatar))?url($customer->avatar):url('/avatar.png')}}" alt="image" />
													</div>
													<!--end::Avatar-->
													<!--begin::Name-->
									...
									<div class="flex-lg-row-fluid ms-lg-15">
										...
										<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
											...
											<!--begin:::Tab item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_customer_view_overview_statements">Events &amp; Logs</a>
											</li>
											<!--end:::Tab item-->
											<!--begin:::Tab item-->
														...
														<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
															...
															<tbody class="fs-6 fw-bold text-gray-600">
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">#{{$sellerid->id}}</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																		<span class="badge badge-light-success">{{$sellerid->delivery_status}}</span>
																	</td>
																	@php
          															$amount = App\Models\OrderDetail::where('order_id',$sellerid->id)->sum('price');
																	...
																	<td class="pe-0 text-end">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																			...
																			<div class="menu-item px-3">
																				<a href="{{route('order.details',$sellerid->id)}}" class="menu-link px-3">View</a>
																			</div>
																			<!--end::Menu item-->
																			<!--begin::Menu item-->
																			<!-- <div class="menu-item px-3">
																		...
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				...
																				<td class="text-gray-800">
																					<a href="#" class="text-gray-900 text-hover-primary">{{$customer->email}}</a>
															...
															<div id="kt_customer_details_invoices_1" class="py-0 tab-pane fade show active" role="tabpanel">
																...
																<table id="kt_customer_details_invoices_table_1" class="table align-middle table-row-dashed fs-6 fw-bolder gy-5">
																	...
																	<tbody class="fs-6 fw-bold text-gray-600">
                                                                        ...
                                                                        <tr>
																			<td>
																				<a href="#" class="text-gray-600 text-hover-primary">#{{$sellerid->id}}</a>
																				@php
          																		$amount = App\Models\OrderDetail::where('order_id',$sellerid->id)->sum('price');
																			...
																			<td class="text-success">{{$amount}} Tk</td>
																			<td>
																				<span class="badge badge-light-info">{{$sellerid->delivery_status}}</span>
																			</td>
																			<td>{{date('d M Y',strtotime($sellerid->date))}}</td>
																		</tr>
                                                                        @endforeach
																...
																<table id="kt_customer_view_statement_table_1" class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-4">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<div class="badge badge-light-success">{{$tickets->status}}</div>
																			@elseif($tickets->status == "Processing")
																			<div class="badge badge-light-warning ">{{$tickets->status}}</div>
																			@elseif($tickets->status == "Close")
																			<div class="badge badge-light-danger">{{$tickets->status}}</div>
																			@endif
																			</td>
																			<td class="text-end">
																			<a href="{{ route('support.ticket.userInfo',$tickets->id)}}" class="btn btn-sm btn-light btn-active-light-primary">View</a>
																			</td>
																		</tr>
																		@endforeach
																	</tbody>
